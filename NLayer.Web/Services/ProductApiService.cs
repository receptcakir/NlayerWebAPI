...
namespace NLayer.Web.Services
{
    public class ProductApiService
    {
        ...
        {
            var response = await _httpClient.GetFromJsonAsync<List<ProductWithCategoryDto>>("products");
            return response;
        }
        ...
        public async Task<List<ProductDto>> GetByCategoryId(int id)
        {
            var response = await _httpClient.GetFromJsonAsync<List<ProductDto>>($"products/GetByCategoryId/{id}");
            return response;
        }
