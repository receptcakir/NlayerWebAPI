...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"İlk",sLast:"Son",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"No data available in table",sInfo:" _START_ Kayıttan _END_ - _TOTAL_ Kayıtlar",sInfoEmpty:" Bulunamadı ",sInfoFiltered:"(  _MAX_ Kayıttan)",sInfoPostFix:"",sDecimal:"",
    sThousands: ",", sLengthMenu: "Sayfada _MENU_ Kayıt Göster", sLoadingRecords: "Yükleniyor...", sProcessing: "Processing...", sSearch: "Bul:", sSearchPlaceholder: "", sUrl: "", sZeroRecords:"Eşleşen Kayıt Bulunmadı"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
